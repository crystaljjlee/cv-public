...
\usepackage[scale=0.8, margin=0.8in]{geometry}
...
\extrainfo{Updated February 2025}                 % optional, remove / comment the line if not wanted
...
\cvitem{2022}{Jonathan Zong*, \textbf{Crystal Lee*}, Alan Lundgard*, JiWoong Jang, Daniel Hajas, Arvind Satyanarayan. ``\href{http://vis.csail.mit.edu/pubs/rich-screen-reader-vis-experiences}{Rich Screen Reader Experiences for Accessible Data Visualization},'' \textit{Eurographics Conference on Visualization} (May 2022). \textit{\textcolor{brown}{\faAward} Honorable Mention.}}
...
\cvitem{2021}{\textbf{Crystal Lee}, Tanya Yang, Gabrielle Inchoco, Graham M. Jones, and Arvind Satyanarayan, ``\href{http://vis.mit.edu/pubs/viral-visualizations}{Viral Visualizations: How Coronavirus Skeptics Use Orthodox Data Practices to Promote Unorthodox Science Online}.'' \textit{ACM Human Factors in Computing Systems (CHI)}, 2021. [\href{https://youtu.be/dj-8DUW39E4}{video}] \textit{\textcolor{brown}{\faAward} Honorable Mention.}}
...
\cvitem{2021}{Calvin Liang, Emily Tseng, Sachin Pendse, \textbf{Crystal Lee}, Kimberley Allison, Neilly H. Tan, Ruotong Wang, Alexandra To, Amy Zhang. ``\href{https://dl.acm.org/doi/10.1145/3462204.3481730}{Subtle CSCW Traits: Tensions Around Identity Formation and Online Activism in the Asian Diaspora}'' workshop, \textit{CSCW '21: Companion Publication of the 2021 Conference on Computer Supported Cooperative Work and Social Computing. October 2021: pp. 347--351}.}
...
\cvitem{July 2024}{``Student Perspectives on Responsible Computing Curricula.'' Summer Training Program on Responsible Computing Education. Northeastern University (July 25, 2024).}

\cvitem{Apr 2024}{``Searching for Alt-Tech and the Parallel Economy.'' Science, Technology, and Society Seminar. Tufts University (March 29, 2024).}

\cvitem{Jan 2024}{``Sensory Encounters in the Age of Computation,'' Science, Technology, and Society Seminar. Rice University (January 27, 2024).}

\cvitem{Sep 2023}{``Sensory Encounters in the Age of Computation,'' Department of Information Science Seminar Series, University of Colorado-Boulder (September 20, 2023).}
...
\cvitem{Mar 2021}{``\href{https://calendar.mit.edu/event/visualmisinformation}{Visualizing Misinformation: Digital Ethnography and Computational Methods in a Pandemic}.'' MIT Digital Humanities Speaker Series (March 18, 2021).}
...
\cvitem{Apr 2024}{``Accessible Data Representations for Screen Reader Users'' (with Arvind Satyanarayan and Jonathan Zong). Emory University.}

\cvitem{Apr 2024}{``Data for Good?'': Work and the Data Economy. Invited closing event facilitator for the joint meeting of the Society for Economic Anthropology and the Society for the Anthropology of Work.}

\cvitem{Nov 2023}{``\href{https://events.umich.edu/event/114550}{A Discussion on Disability Justice, Human Rights, and the Politics of Space}.'' Donia Human Rights Center, University of Michigan (invited panel with Lydia X. Z. Brown, Eman Rimawi-Doster, Laura Guidry-Grimes).}
...
\cvitem{}{\textit{N.B.: Conference talks that present a peer-reviewed paper at the publication venue are not listed here (e.g., ACM and IEEE conferences).}}

\cvitem{Mar 2024}{``Who is the Human in Human-Computer Interaction?,'' in Disability and/as Method in the Study of Media Technologies, Society for Cinema and Media Studies (paper on panel with Meryl Alper, Elizabeth Ellcessor, Jess Rauchberg). Boston, MA (March 14--17).} 
...
\cvitem{2021}{``\href{https://www.youtube.com/live/RvHF1Crpqvk?feature=share}{Toward Accessible Data Representation}s'' workshop, IEEE Visualization (co-organized with Arvind Satyanarayan, Danielle Szafir, Keke Wu, and Alan Lundgard). Speakers: Cynthia Bennett, Chancey Fleet, Zoe Gross, Ariel Schwartz, and Rua Williams.}

\cvitem{2021}{Conference Plenary Session: ``\href{http://web.mit.edu/crystall/www/files/SHOT2020-MakingHistory.pdf}{Making and Doing History: On Non-Traditional Modes of Critical Engagement}'' roundtable discussion, Society for the History of Technology, New Orleans, LA (with Ranjodh Dhaliwal).
...
\cvitem{2018}{``\href{http://web.mit.edu/crystall/www/files/HSS2018-Taste.pdf}{Technologies of Taste}'' panel, History of Science Society, Seattle, WA (with Hannah Leblanc).}
...
\cvitem{Nov 2023}{* Institute for Data Systems and Society Faculty Lunch Seminar Series.} 

\cvitem{Oct 2023}{* ``Can AI be designed for everyone?'' Kensho AI Ethics Speaker Seminar Series (October 24, 2023).}

\cvitem{Nov 2022}{* Data Analysis Donuts: Internal Discussion at ObservableHQ on misinformation (November 3, 2022).}

\cvitem{Aug 2022}{* NSF-funded Workshop on Inclusive and Intersectional Research and Analysis in Engineering and Computer Science (invited participant), Stanford University (August 25–26, 2022).}

\cvitem{June 2022}{Greater Boston Areas AI Ethics Lightning Round. Ethical Issues in Computing and AI: Research Questions and Pedagogical Strategies, Harvard University (June 1, 2022).}

\cvitem{Mar 2022}{* Access Washing in Data Policy and Practice (invited roundtable discussant). Minderoo Centre for Technology and Democracy, University of Cambridge (March 3, 2022).}

\cvitem{June 2021}{Flash talk, VIS Summer Camp (co-organized by Universities of Florida, Arizona, Utah; Northwestern, Northeastern, and MIT).}

\cvitem{June 2021}{* ``\href{https://docs.google.com/document/d/1kPNXCEOhGEc9dqKapwK6ZwrV6U72fkmOPK2Lxq-0gxs/edit?q=data+hoarders}{The Future of the Digital Archive: Data Hoarders and Radical Librarianship}.'' \textit{House/Keeping: Domestic Accumulation, Decluttering, and the Stuff of Kinship in Anthropological Perspective}, Laboratoire d'Anthropologie des Mondes Contemporains, Université libre de Bruxelles (May 31–June 2, 2021).} 

\cvitem{May 2021}{``Methodological Challenges to Studying Online Radicalization'' (with John A. Maldonado and Jonas Kaiser). Workshop discussion, Berkman Klein Center for Internet and Society Festival of Ideas (May 7, 2021).} 

\cvitem{Mar 2021}{ACM FAccT Doctoral Consortium. Virtual conference (March 3--10, 2021).}

\cvitem{Feb 2021}{* Discussion on ``Viral Visualizations'' project. \textit{MIT Data + Feminism Lab} (March 26, 2021); \textit{University of Washington Social Futures Lab} (February 9, 2021).} 

\cvitem{Feb 2020}{Discussant, ``Cripping the History of Computing.'' \textit{MIT HASTS Program Seminar}.}

\cvitem{Sep 2018}{Discussant, ``Searching for Google.'' \textit{MIT HASTS}.} 

\cvitem{Sep 2017}{Discussant, ``The Multiple Autonomies of Self-Driving Cars.'' \textit{MIT HASTS}.} 

\cvitem{Apr 2017}{Discussant, ``Crafting Nanotechnology for Art and Heritage Conservation.'' \textit{MIT HASTS}.}

\cvitem{Sep 2016}{``Lining Things Up: Mapping Time, Power, and Politics.'' \textit{MIT HASTS}.} 

\cvitem{Jan 2016}{``Digital Methods in History.'' History of Science Workshop, Stanford University.}
...
\cvitem{Summer 2023}{\textbf{Landscape analysis, responsible computing student groups}: Princess Vongchanh (Stanford)}
...
\cvitem{2023}{Max Lisnic (PhD candidate, School of Computing, University of Utah).}
...
\subsection{Courses} 
    ...
    \cvitem{Spring 2025}{Interactive Data Visualization and Society}

    \cvitem{Fall 2024}{Introduction to Media Studies}
    
    \cvitem{Spring 2024}{Introduction to Media Studies (evaluation: 6.9/7.0, 21 students)}

\subsection{Guest Lectures}

    \cvitem{Summer 2024}{``Exploring the Responsible Tech Ecosystem,'' Introduction to Computational Thinking for Teachers (Steven Azeka), College of Staten Island CUNY}

    \cvitem{Spring 2024}{Science for the People (Luis Campos), Rice University}

    \cvitem{Fall 2023}{``Who's Responsible for Responsible Tech?'' Critical Internet Studies (Sulafa Zidani), Northwestern University}

    \cvitem{Fall 2023}{``Who's Responsible for Responsible Tech?'' Introduction to Information Systems (Gracen Brilmyer), McGill University}

    \cvitem{Fall 2023}{``Sensory Encounters in the Age of Computation,'' Institute for Data Systems and Society Doctoral Seminar (Ali Jadbabaie and Alberto Abadie), MIT}

    \cvitem{Spring 2023}{Judge for final projects, Machine Learning and Society (Atri Rudra and Kenny Joseph), University at Buffalo}

    \cvitem{Spring 2023}{``Academic ableism,'' Feminist Disability Studies (Lydia XZ Brown), Georgetown University}
...
\subsection{Service to the Profession}
    \cvitem{2023}{Program Committee, ACM Special Interest Group on Computer Science Education (SIGCSE)}
    \cvitem{2021}{Program Committee, Visualization for Social Good Workshop, IEEE Visualization (VIS)}
    \cvitem{2020}{Program Committee, ACM Conference on Fairness, Accountability, and Transparency (FAccT)}

\subsection{Peer Review}
    \cvitem{Conferences}{IEEE VIS; ACM SIGCSE, FAccT, CHI, NeurIPS (ethics committee)} 
    \cvitem{Books}{MIT Press}
    \cvitem{Journals}{\textit{Public Culture}}
    \cvitem{Grants}{Just Tech Fellowship, Social Science Research Council}

\subsection{Institutional Service}
    \cvitem{2024–}{Member, CMS/W Junior and Senior Search Committee}
    \cvitem{2024}{Panelist, SHASS Faculty Panel on Research Statements}
    \cvitem{2024}{Member, Admissions Committee for the Technology and Policy Program}
    \cvitem{2023–}{Faculty co-organizer, MIT CSAIL Human-Computer Interaction Seminar}
    \cvitem{2023–}{Member, CMS/W Diversity, Equity, and Inclusion Committee}
...
\section{Professional Organizations} 
    \cvitem{2020--}{Association for Computing Machinery (ACM), Society for Disability Studies (SDS)} 
